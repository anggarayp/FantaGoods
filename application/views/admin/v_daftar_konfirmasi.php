		...
		foreach($DataKonfirmasi as $BarisData){
			...
			?>
				<tr>
					...
					<td class="text-center">
					    <a href="<?php echo site_url('order/detail/'.$BarisData['id_pembelian']);?>"  class="btn btn-info btn-sm" style="background-color: #6592e6; border: 2px solid #6592e6" data-judulbox="Detail Pembelian" data-judul="Detail Order" data-toggle="modal" data-target="#KotakDialog">Detail</a>							
