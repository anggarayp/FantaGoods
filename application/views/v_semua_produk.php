<h2 class="text-center font-weight-bold mt-5 mb-5" style="color: #023980">Daftar Produk</h2>
<div class="row">
			<!-- item produk -->
			<?php
				if(isset($SemuaProduk)) { 
					foreach($SemuaProduk as $DataProduk) {
				...
				<div class="card mb-2">
					<div class="card-header text-center font-weight-bold "><?php echo $DataProduk['nama_produk'];?></div>
						...
						<div class="card-body">
							...
							<a href="<?php echo site_url('home/detail/'.$DataProduk['kode_produk']);?>" class="btn text-white" style="background-color: #ff9966; border: 2px solid #ff9966" data-judul="Detail Produk" data-toggle="modal" data-target="#KotakDialog">Detail</a>
